  ...
  return (
    <form styleName="values-form" onSubmit={(e) => handleSubmit(e)}>
      ...
      <div styleName="values-form__container">
        ...
        <div styleName="values-form__control">
          <TextField value={props.yCurrent} changeValue={props.changeY} maxLength="4" placeholder="Число от -3 до 3" />
        </div>
      </div>

      <div>
        <Button onClick={handleCheckCLick} htmlType="submit">Проверить</Button>
        <Button onClick={handleClearCLick} htmlType="submit">Очистить</Button>
      </div>
    </form>
  );
}
